...
const locales = {
    ...
    ru: {
        ...
        '.textLong1': "<p class='textLong1' style='font-size: 0.65rem; margin-left: 0px;'>Мы готовим фундамент для настоящей соревновательной арены.<br>В будущем обновлении мы представим <b>Глобальную Таблицу Лидеров</b> — систему,<br>которая выведет конкуренцию на новый уровень. Сравнивайте свои достижения с игроками<br>со всего мира в двух ключевых категориях.</p>",
        '.textLong2': "<p class='textLong2' style='font-size: 0.65rem; margin-left: 0px;'>Мы создаем полноценную игровую экономику.<br>В следующем крупном обновлении мы представим <b>децентрализованный P2P маркетплейс</b>,<br>где игроки получат полный контроль над своими активами.</p>",
        '.textLong3': "<p class='textLong3' style='font-size: 0.65rem; margin-left: 0px;'>Мы дадим вам новые способы выделиться и продемонстрировать свой стиль.<br>В ближайшем обновлении в вашем профиле откроется <b>магазин эксклюзивных аксессуаров</b>,<br>где вы сможете персонализировать свое игровое пространство.</p>",
        '.textLong4': "<p class='textLong4' style='font-size: 0.65rem; margin-left: 0px;'>Мы создаём новую ценность и элитный статус введением<br><b>VIP Статуса</b> — системы эксклюзивных привилегий для самых преданных игроков.<br>Откройте доступ к уникальным возможностям, которые выведут<br>ваш игровой опыт на новый уровень. Особые визуальные элементы,<br>расширенные лимиты и эксклюзивные экономические преимущества — всё это станет доступно<br>с получением статуса.</p>",
...
document.querySelector('.privacyBtn').addEventListener('click', function() {
    const baseUrl = 'https://mixagrech.github.io';
    window.location.href = `${baseUrl}/surprise/privacy`;
});
